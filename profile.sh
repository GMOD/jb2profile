...
node express_cross_origin_isolated/index.js jbrowse 8002 &

sleep 1

profile () {
  echo $0 $1 $2 $3 $4
  hyperfine --show-output --export-json $3.json --runs 1  \
    ...
    "node profile_jb1web.js \"http://localhost:8002/?loc=$1&assembly=$4&tracks=$2 aln,$2 snp\" \"$3_fps_8002.json\" \"$3_mem_8002.json\""
  echo -e "\n\n\n\n\n\n\n"
}
